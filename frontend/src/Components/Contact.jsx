        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          >
            ...
            <motion.button
              ...
              className="w-full rounded-xl py-3.5 font-display text-sm font-bold uppercase tracking-wide transition-smooth shadow-glow disabled:opacity-60"
              style={{ backgroundColor: "#FEE101", color: "#0B0E14" }}
            >
            ...
            {status === "error" && (
              <motion.p
                ...
                initial={{ opacity: 0, y: -8 }}
                animate={{ opacity: 1, y: 0 }}
                className="text-center font-body text-sm font-medium text-destructive"
              >
                {errorMessage}
              </motion.p>
            )}
